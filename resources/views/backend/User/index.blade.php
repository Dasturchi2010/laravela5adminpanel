...
@section('content')
    ...
    <div class="col-12 text-center">
        <h1 class="text-primary">Userlar</h1>
    </div>

    <div class="col-12 text-right">
        <a href="{{ route('users.create') }}" class="btn btn-success btn-sm mb-1">Qo'shish</a>
    </div>
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->email }}</td>
                        <td>
                            <img width="40" height="40" src="{{ asset('/storage/' . $user->image) }}" alt="img error">
                        </td>
                        <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <form action="{{ route('users.destroy', $user->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button @if(auth()->user()->id ==$user->id) disabled @endif style="width: 100%" type="submit" class="dropdown-item" onclick="return confirm('Userni o\'chirmoqchimisiz')">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
