    ...
    <div class="media-body mt-50">
        ...
        <form action="{{ route('updateImage') }}" method="post" enctype="multipart/form-data" id="update-image-form">
            ...
            <div class="col-12 d-flex mt-1 px-0">
                <label class="btn btn-primary btn-sm mr-75 mb-0 waves-effect waves-float waves-light" for="change-picture">
...
<form action="{{ route('profile.update') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-12 mt-2 d-flex flex-sm-row flex-column">
            <div class="form-group">
