                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            ...
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('backend/app-assets/images/pages/login-v2.svg') }}"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Sizga berilgan email va parolni kiriting</p>
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="login-email" type="text" name="email"
                                            placeholder="alicoder@gmail.com" aria-describedby="login-email"
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="remember-me"> Eslab
                                                qolish</label>
                                        </div>
                                    </div>
                                    <button class="btn btn-primary btn-block" tabindex="4">Kirish</button>
                                </form>
                                <p class="text-center mt-2"><span>Sizda login yo'qmi?</span><a
                                        href="{{ route('register') }}"><span>&nbsp;Ro'yxatdan o'tish</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
